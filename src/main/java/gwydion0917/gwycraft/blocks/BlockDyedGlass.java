...
public class BlockDyedGlass extends BlockGlass implements MultiItem {
    public static final PropertyEnum<EnumDyeColor> COLOR = PropertyEnum.create("color", EnumDyeColor.class);

    public BlockDyedGlass(String name) {
        this(name, 0f);
    }

    public BlockDyedGlass(String name, float lightLevel) {
