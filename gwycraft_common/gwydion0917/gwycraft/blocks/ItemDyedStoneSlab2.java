...
//	private final static String[] subNames = { "lightGrey", "cyan", "purple", "blue", "brown", "green", "red", "black" };
	    ...
	    public ItemDyedStoneSlab2(int par1, BlockHalfSlab par2BlockHalfSlab, BlockHalfSlab par3BlockHalfSlab, boolean par4)
	    {
	        super(par1);
