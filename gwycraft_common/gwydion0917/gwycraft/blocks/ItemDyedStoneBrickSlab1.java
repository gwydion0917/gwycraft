...
public class ItemDyedStoneBrickSlab1 extends ItemSlab {
	...
	public ItemDyedStoneBrickSlab1(int par1, BlockHalfSlab par2BlockHalfSlab,
			BlockHalfSlab par3BlockHalfSlab, boolean par4) {
		super(par1, par2BlockHalfSlab, par3BlockHalfSlab, par4);
		this.theHalfSlab = Gwycraft.blockDyedStoneBrickSlab1;
		this.doubleSlab = Gwycraft.blockDyedStoneBrickDoubleSlab1;
		this.isFullBlock = false;
		this.setMaxDamage(0);
		this.setHasSubtypes(true);
		setUnlocalizedName("blockDyedStoneBrickSlab1");
	}
	...
	// boolean flag = (j1 & 8) != 0;
	//
	// if ((par7 == 1 && !flag || par7 == 0 && flag) && i1 ==
	// this.theHalfSlab.blockID && k1 == par1ItemStack.getItemDamage())
	// {
	// if
	// (par3World.checkNoEntityCollision(this.doubleSlab.getCollisionBoundingBoxFromPool(par3World,
	// par4, par5, par6)) && par3World.setBlock(par4, par5, par6,
	// this.doubleSlab.blockID, k1, 3))
	// {
	// par3World.playSoundEffect((double)((float)par4 + 0.5F),
	// (double)((float)par5 + 0.5F), (double)((float)par6 + 0.5F),
	...
	// else
	// {
	// return this.func_77888_a(par1ItemStack, par2EntityPlayer, par3World,
	// par4, par5, par6, par7) ? true : super.onItemUse(par1ItemStack,
	// par2EntityPlayer, par3World, par4, par5, par6, par7, par8, par9, par10);
	// }
	// }
	// }
	...
	public boolean canPlaceItemBlockOnSide(World par1World, int par2, int par3,
		...
		if ((par5 == 1 && !flag || par5 == 0 && flag)
			...
			j2 = i2 & 7;
			flag = (i2 & 8) != 0;
			return l1 == this.theHalfSlab.blockID
					&& j2 == par7ItemStack.getItemDamage() ? true : super
					.canPlaceItemBlockOnSide(par1World, i1, j1, k1, par5,
	...
	// FIXME: This needs to be fixed
	// @Override
	// private boolean func_77888_a(ItemStack par1ItemStack, EntityPlayer
	// par2EntityPlayer, World par3World, int par4, int par5, int par6, int
	// par7)
	// {
	// if (par7 == 0)
	...
	// int k1 = j1 & 7;
	//
	// if (i1 == this.theHalfSlab.blockID && k1 ==
