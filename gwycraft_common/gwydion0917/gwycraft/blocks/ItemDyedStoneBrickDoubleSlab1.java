...
public class ItemDyedStoneBrickDoubleSlab1 extends ItemSlab {
	...
	public ItemDyedStoneBrickDoubleSlab1(int par1,
			BlockHalfSlab par2BlockHalfSlab, BlockHalfSlab par3BlockHalfSlab,
			boolean par4) {
		super(par1, par2BlockHalfSlab, par3BlockHalfSlab, true);
	...
	// if (par3World.checkNoEntityCollision(this.doubleSlab
	...
	// FIXME: This needs to be updated to the proper named method
	// @Override
	// private boolean func_77888_a(ItemStack par1ItemStack,
	// EntityPlayer par2EntityPlayer, World par3World, int par4, int par5,
	// int par6, int par7) {
	// if (par7 == 0) {
	// --par5;
	...
	// int k1 = j1 & 7;
	//
	// if (i1 == this.theHalfSlab.blockID
	// && k1 == par1ItemStack.getItemDamage()) {
	// if (par3World.checkNoEntityCollision(this.doubleSlab
	// .getCollisionBoundingBoxFromPool(par3World, par4, par5,
	// par6))
