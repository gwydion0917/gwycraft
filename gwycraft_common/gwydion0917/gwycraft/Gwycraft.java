...
public class Gwycraft {
    ...
    public static BlockBookshelf glowydyedBookcase;
    ...
    public static Block glowydyedLeaf;
    public static Block dyedLog1;
    public static Block dyedLog2;
    public static Block dyedLog3;
    public static Block dyedLog4;
    public static Block glowydyedLog1;
    public static Block glowydyedLog2;
    public static Block glowydyedLog3;
    public static Block glowydyedLog4;
...
//    public static Block blockDyedStonePaver2;
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		dyedStone = new BlockGwyGenericBlock(ConfigGwycraft.dyedStoneID, Material.rock, "stone").setHardness(1.5F).setResistance(10.0F).setStepSound(Block.stone.stepSound).setUnlocalizedName("Gwycraft:dyedStone").setCreativeTab(tabs);
        glowydyedStone = new BlockGwyGenericBlock(ConfigGwycraft.glowydyedStoneID, Material.rock, "stone").setLightValue(1F).setHardness(1.5F).setResistance(10.0F).setStepSound(Block.stone.stepSound).setUnlocalizedName("Gwycraft:glowydyedStone").setCreativeTab(tabs);
        ...
        glowydyedBookcase = (BlockBookshelf) new BlockDyedBookcase(ConfigGwycraft.glowydyedBookcaseID, Material.wood).setLightValue(1F).setHardness(1.5F).setStepSound(Block.wood.stepSound).setUnlocalizedName("Gwycraft:glowydyedBookcase").setCreativeTab(tabs);
		dyedBrick = new BlockGwyGenericBlock(ConfigGwycraft.dyedBrickID, Material.rock, "brick").setCreativeTab(tabs);
		glowydyedBrick = new BlockGwyGenericBlock(ConfigGwycraft.glowydyedBrickID, Material.rock, "brick").setLightValue(1F).setHardness(2F).setStepSound(Block.stone.stepSound).setResistance(10F).setUnlocalizedName("Gwycraft:glowydyedBrick").setCreativeTab(tabs);
		dyedClayblock = new BlockGwyGenericBlock(ConfigGwycraft.dyedClayblockID, Material.rock, "clayblock").setCreativeTab(tabs);
		glowydyedClayblock = new BlockGwyGenericBlock(ConfigGwycraft.glowydyedClayblockID, Material.rock, "clayblock").setLightValue(1F).setHardness(0.6F).setStepSound(Block.stone.stepSound).setUnlocalizedName("Gwycraft:glowydyedClayblock").setCreativeTab(tabs);
		...
		dyedLeaf = new BlockDyedLeaf(ConfigGwycraft.dyedLeafID).setCreativeTab(tabs).setUnlocalizedName("Gwycraft:dyedLeaf");
        glowydyedLeaf = new BlockDyedLeaf(ConfigGwycraft.glowydyedLeafID).setCreativeTab(tabs).setLightValue(1F).setUnlocalizedName("Gwycraft:glowydyedLeaf");
		blockDyedMudBrick = new BlockGwyGenericBlock(ConfigGwycraft.blockDyedMudBrickID, Material.rock, "mudbrick").setCreativeTab(tabs);
		glowyblockDyedMudBrick = new BlockGwyGenericBlock(ConfigGwycraft.glowyBlockDyedMudBrickID, Material.rock, "mudbrick").setLightValue(1F).setHardness(1.5f).setStepSound(Block.stone.stepSound).setUnlocalizedName("Gwycraft:dyedMudbrick").setCreativeTab(tabs);
		dyedPlank = new BlockGwyGenericBlock(ConfigGwycraft.dyedPlankID, Material.wood, "plank").setHardness(2.0F).setResistance(5.0F).setStepSound(Block.soundWoodFootstep).setUnlocalizedName("Gwycraft:dyedPlank").setCreativeTab(tabs);
		glowydyedPlank = new BlockGwyGenericBlock(ConfigGwycraft.glowydyedPlankID, Material.wood, "plank").setLightValue(1F).setHardness(2.0F).setResistance(5.0F).setStepSound(Block.soundWoodFootstep).setUnlocalizedName("Gwycraft:glowydyedPlank").setCreativeTab(tabs);
		...
		dyedStonebrick = new BlockGwyGenericBlock(ConfigGwycraft.dyedStonebrickID, Material.rock, "stonebrick").setLightValue(1F).setHardness(2f).setStepSound(Block.stone.stepSound).setUnlocalizedName("Gwycraft:dyedStonebrick").setCreativeTab(tabs);
		glowydyedStonebrick = new BlockGwyGenericBlock(ConfigGwycraft.glowydyedStonebrickID, Material.rock, "stonebrick").setLightValue(1F).setHardness(2f).setStepSound(Block.stone.stepSound).setUnlocalizedName("Gwycraft:glowydyedStonebrick").setCreativeTab(tabs);
		dyedStonecobble = new BlockGwyGenericBlock(ConfigGwycraft.dyedStonecobbleID, Material.rock, "stonecobble").setHardness(2.0F).setResistance(10.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("Gwycraft:dyedStonecobble").setCreativeTab(tabs);
		glowydyedStonecobble = new BlockGwyGenericBlock(ConfigGwycraft.glowydyedStonecobbleID, Material.rock, "stonecobble").setLightValue(1F).setHardness(2.0F).setResistance(10.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("Gwycraft:glowydyedStonecobble").setCreativeTab(tabs);
        ...
        dyedLog1 = new BlockDyedLog1(ConfigGwycraft.dyedLog1ID).setCreativeTab(tabs).setUnlocalizedName("Gwycraft:dyedLog1");
        dyedLog2 = new BlockDyedLog2(ConfigGwycraft.dyedLog2ID).setCreativeTab(tabs).setUnlocalizedName("Gwycraft:dyedLog2");
        dyedLog3 = new BlockDyedLog3(ConfigGwycraft.dyedLog3ID).setCreativeTab(tabs).setUnlocalizedName("Gwycraft:dyedLog3");
        dyedLog4 = new BlockDyedLog4(ConfigGwycraft.dyedLog4ID).setCreativeTab(tabs).setUnlocalizedName("Gwycraft:dyedLog4");
        glowydyedLog1 = new BlockDyedLog1(ConfigGwycraft.glowydyedLog1ID).setCreativeTab(tabs).setUnlocalizedName("Gwycraft:glowydyedLog1");
        glowydyedLog2 = new BlockDyedLog2(ConfigGwycraft.glowydyedLog2ID).setCreativeTab(tabs).setUnlocalizedName("Gwycraft:glowydyedLog2");
        glowydyedLog3 = new BlockDyedLog3(ConfigGwycraft.glowydyedLog3ID).setCreativeTab(tabs).setUnlocalizedName("Gwycraft:glowydyedLog3");
        glowydyedLog4 = new BlockDyedLog4(ConfigGwycraft.glowydyedLog4ID).setCreativeTab(tabs).setUnlocalizedName("Gwycraft:glowydyedLog4");
...
//      Slabs
        ...
        GameRegistry.registerBlock(glowydyedBookcase, ItemDyedBookshelf.class, "glowydyedBookcase");
        ...
        GameRegistry.registerBlock(glowydyedLeaf, ItemDyedLeaf.class, "glowydyedLeaf");
        ...
        GameRegistry.registerBlock(glowydyedLog1, ItemDyedLog1.class, "glowydyedLog1");
        GameRegistry.registerBlock(glowydyedLog2, ItemDyedLog2.class, "glowydyedLog2");
        GameRegistry.registerBlock(glowydyedLog3, ItemDyedLog3.class, "glowydyedLog3");
        GameRegistry.registerBlock(glowydyedLog4, ItemDyedLog4.class, "glowydyedLog4");
...
//Slabs
        ...
        Item.itemsList[ConfigGwycraft.blockDyedStoneBrickSlab1ID] = (new ItemSlab (ConfigGwycraft.blockDyedStoneBrickSlab1ID - 256, (BlockHalfSlab)blockDyedStoneBrickSlab1, blockDyedStoneBrickDoubleSlab1, false)).setUnlocalizedName("blockDyedStoneBrickSlab1");
        Item.itemsList[ConfigGwycraft.blockDyedStoneBrickSlab2ID] = (new ItemSlab (ConfigGwycraft.blockDyedStoneBrickSlab2ID - 256, (BlockHalfSlab)blockDyedStoneBrickSlab2, blockDyedStoneBrickDoubleSlab2, false)).setUnlocalizedName("blockDyedStoneBrickSlab2");
        ...
        for (int i = 0; i < 16; i++) {
            ...
            ItemStack glowydyedBookcaseStack = new ItemStack(glowydyedBookcase, 1, i);
            ...
            ItemStack glowydyedLeafStack = new ItemStack(glowydyedLeaf, 1, i);
            ...
            LanguageRegistry.addName(glowydyedBookcaseStack, "Glowy " + gwyColorNames[glowydyedBookcaseStack.getItemDamage()] + " Bookcase");
            ...
            LanguageRegistry.addName(glowydyedLeafStack, "Glowy " + gwyColorNames[dyedLeafStack.getItemDamage()] + " Leaf");
            ...
            GameRegistry.addRecipe(new ItemStack(glowydyedBookcase, 1, i), "###", "XXX", "###", '#', glowydyedPlankStack, 'X', Item.book);
            ...
            GameRegistry.addShapelessRecipe(new ItemStack(glowydyedSand, 8, i), itemEnchantedGemsStack, Block.sand, Block.sand, Block.sand, Block.sand, Block.sand, Block.sand, Block.sand, Block.sand);
            ...
            GameRegistry.addShapelessRecipe(new ItemStack(glowydyedStonecobble, 8, i), itemEnchantedGemsStack, Block.cobblestone, Block.cobblestone, Block.cobblestone, Block.cobblestone, Block.cobblestone, Block.cobblestone, Block.cobblestone, Block.cobblestone);
            ...
            GameRegistry.addShapelessRecipe(new ItemStack(glowydyedPlank, 8, i), itemEnchantedGemsStack, Block.planks, Block.planks, Block.planks, Block.planks, Block.planks, Block.planks, Block.planks, Block.planks);
            ...
            for (int j = 0; j < 4; j++) {
                ...
                GameRegistry.addShapelessRecipe(new ItemStack(glowydyedLeaf, 8, i), itemEnchantedGemsStack, leaf, leaf, leaf, leaf, leaf, leaf, leaf, leaf);
            }
        ...
        for (int i = 0; i < 8; i++) {
            ...
            GameRegistry.addRecipe(new ItemStack(blockDyedStonePaver, 12, i), "XXX", 'X', dyedStoneSlab1Stack);
            GameRegistry.addRecipe(new ItemStack(blockDyedStonePaver, 12, i+8), "XXX", 'X', dyedStoneSlab2Stack);
        }        
        ...
        for (int i = 0; i < 4; i++) {
            ...
            ItemStack glowydyedLog1Stack = new ItemStack(glowydyedLog1, 1, i);
            ItemStack glowydyedLog2Stack = new ItemStack(glowydyedLog2, 1, i);
            ItemStack glowydyedLog3Stack = new ItemStack(glowydyedLog3, 1, i);
            ItemStack glowydyedLog4Stack = new ItemStack(glowydyedLog4, 1, i);
            ...
            LanguageRegistry.addName(glowydyedLog1Stack, "Glowy " + gwyColorLog1Names[glowydyedLog1Stack.getItemDamage()] + " Log");
            LanguageRegistry.addName(glowydyedLog2Stack, "Glowy " + gwyColorLog2Names[glowydyedLog2Stack.getItemDamage()] + " Log");
            LanguageRegistry.addName(glowydyedLog3Stack, "Glowy " + gwyColorLog3Names[glowydyedLog3Stack.getItemDamage()] + " Log");
            LanguageRegistry.addName(glowydyedLog4Stack, "Glowy " + gwyColorLog4Names[glowydyedLog4Stack.getItemDamage()] + " Log");
            ...
            GameRegistry.addShapelessRecipe(new ItemStack(glowydyedPlank, 4, i), glowydyedLog1Stack);
            GameRegistry.addShapelessRecipe(new ItemStack(glowydyedPlank, 4, i+4), glowydyedLog2Stack);
            GameRegistry.addShapelessRecipe(new ItemStack(glowydyedPlank, 4, i+8), glowydyedLog3Stack);
            GameRegistry.addShapelessRecipe(new ItemStack(glowydyedPlank, 4, i+12), glowydyedLog4Stack);
            ...
            for (int j = 0; j < 4; j++) {
                ...
                GameRegistry.addShapelessRecipe(new ItemStack(glowydyedLog1, 8, i), itemEnchantedGemsStack1, log, log, log, log, log, log, log, log);
                GameRegistry.addShapelessRecipe(new ItemStack(glowydyedLog2, 8, i), itemEnchantedGemsStack2, log, log, log, log, log, log, log, log);
                GameRegistry.addShapelessRecipe(new ItemStack(glowydyedLog3, 8, i), itemEnchantedGemsStack3, log, log, log, log, log, log, log, log);
                GameRegistry.addShapelessRecipe(new ItemStack(glowydyedLog4, 8, i), itemEnchantedGemsStack4, log, log, log, log, log, log, log, log);
            }
        }
