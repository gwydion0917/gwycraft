...
//        Item.itemsList[ConfigGwycraft.itemGemShearsID] = (new ItemGemShears (ConfigGwycraft.itemGemShearsID)).setUnlocalizedName("Gwycraft:itemgemshears");
        ...
        for (int i = 0; i < 16; i++) {
            ...
            for (int j = 0; j < 4; j++) {
                ...
                GameRegistry.addShapelessRecipe(new ItemStack(glowydyedLeaf, 8, i), itemFlawedGemsStack, leaf, leaf, leaf, leaf, leaf, leaf, leaf, leaf);
            }
        ...
        for (int i = 0; i < 4; i++) {
            ...
            ItemStack itemEnchantedGemsStack1 = new ItemStack(itemFlawedGems, 1, i);
            ItemStack itemEnchantedGemsStack2 = new ItemStack(itemFlawedGems, 1, i+4);
            ItemStack itemEnchantedGemsStack3 = new ItemStack(itemFlawedGems, 1, i+8);
            ItemStack itemEnchantedGemsStack4 = new ItemStack(itemFlawedGems, 1, i+12);
